...
export class RecService {
  ...
  public recs: Rec[] = [
    ...
    {id: 4, posId: 5, depId: 2, phoneWIDs: [10], name: 'Петрова Надежда Яковлевна', phone: '+375(44)379-78-83(мтс), +375(29)647-34-65(a1)'},
    ...
    {id: 10, posId: 3, depId: 5, phoneWIDs: [23], name: 'Колесников Виталий Михайлович', phone: '254-47-26(дом), +375(25)746-76-24 (Life)'}
  ];
